...
import com.bt.busticket.databinding.FragmentNewTripBinding;
...
import com.bt.busticket.viewmodel.NewTripViewModel;
...
public class NewTripFragment extends Fragment {
    ...
    private boolean validateForm() {
        ...
        if (TextUtils.isEmpty(origin)) {
            binding.origin.setError(getString(com.bt.busticket.R.string.required));
            valid = false;
        } else {
