...
import com.bt.busticket.databinding.DialogUserDetailBinding;
...
import com.bt.busticket.viewmodel.UserDetailsViewModel;
...
public class UserDetailDialogFragment extends DialogFragment {
    ...
    private boolean validateForm() {
        ...
        if (emailEdt == null || TextUtils.isEmpty(emailEdt.getText().toString())) {
            binding.fieldEmail.setError(getString(com.bt.busticket.R.string.required));
            valid = false;
        } else {
