...
import com.bt.busticket.databinding.FragmentLoginBinding;
import com.bt.busticket.model.AuthErrorType;
import com.bt.busticket.viewmodel.LoginViewModel;
...
public class LoginFragment extends BaseFragment {
    ...
    private boolean validateForm() {
        ...
        if (TextUtils.isEmpty(email)) {
            mBinding.fieldEmail.setError(getString(com.bt.busticket.R.string.required));
            valid = false;
        } else {
