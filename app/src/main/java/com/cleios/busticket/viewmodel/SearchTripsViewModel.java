...
public class SearchTripsViewModel extends ViewModel {
    ...
    public SearchTripsViewModel(TripFinder tripFinder, TripDeleter tripDeleter) {
    ...
    public static final ViewModelInitializer<SearchTripsViewModel> initializer = new ViewModelInitializer<>(
            ...
            creationExtras -> {
                ...
                assert app != null;
                return new SearchTripsViewModel(app.appModule.tripFinder, app.appModule.tripDeleter);
            }
    );
